...
#define SUB_S_ADMIN_STORAGE_INFO  111                 //库存消息
...
#define SUB_C_CONTINUE_CARD     14                  //继续发牌
#define SUB_C_CHECK_IMAGE     15                  //继续发牌
#define SUB_C_ADMIN_COMMDN      16                  //系统控制
#define SUB_C_STORAGE       17                  //更新库存
#define SUB_C_STORAGEINFO     18                  //更新库存
