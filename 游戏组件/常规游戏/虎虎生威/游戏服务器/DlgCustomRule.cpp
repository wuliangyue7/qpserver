...
//  FormatDataCheck(m_CustomConfig.CustomGeneral.cbGuessTime,     15,   99,     TEXT("猜大小时间"), true);
  ...
  FormatDataCheck(m_CustomConfig.CustomGeneral.lEndGameMul,     1,    100,    TEXT("提前开牌比例"),true);

  //库存控制
  FormatDataCheck(m_CustomConfig.CustomGeneral.StorageStart,      0,    LLONG_MAX,  TEXT("库存起始值"), true);
  FormatDataCheck(m_CustomConfig.CustomGeneral.StorageDeduct,     0,    1000,   TEXT("库存衰减值"), true);
  ...
  FormatDataCheck(m_CustomConfig.CustomAndroid.lRobotMinJetton,     10,   100000000,  TEXT("筹码金额最小"),   false);
  FormatDataCheck(m_CustomConfig.CustomAndroid.lRobotMaxJetton,     10,   100000000,  TEXT("筹码金额最大"),   false);
...
{
  __super::OnInitDialog();
  m_DefaultData[0].nControlID=IDC_EDIT_GENERAL_1;
  m_DefaultData[0].szBuf.Format(TEXT("%I64d"),m_CustomGeneral.lApplyBankerCondition);
  m_DefaultData[1].nControlID=IDC_EDIT_GENERAL_2;
  m_DefaultData[1].szBuf.Format(TEXT("%I64d"),m_CustomGeneral.lBankerTime);
  m_DefaultData[2].nControlID=IDC_EDIT_GENERAL_3;
  m_DefaultData[2].szBuf.Format(TEXT("%I64d"),m_CustomGeneral.lBankerTimeAdd);
  m_DefaultData[3].nControlID=IDC_EDIT_GENERAL_4;
  m_DefaultData[3].szBuf.Format(TEXT("%I64d"),m_CustomGeneral.lBankerScoreMAX);
  m_DefaultData[4].nControlID=IDC_EDIT_GENERAL_5;
  m_DefaultData[4].szBuf.Format(TEXT("%I64d"),m_CustomGeneral.lBankerTimeExtra);
  m_DefaultData[5].nControlID=IDC_EDIT_GENERAL_6;
  m_DefaultData[5].szBuf.Format(TEXT("%d"),m_CustomGeneral.cbFreeTime);
  m_DefaultData[6].nControlID=IDC_EDIT_GENERAL_7;
  m_DefaultData[6].szBuf.Format(TEXT("%d"),m_CustomGeneral.cbBetTime);
  m_DefaultData[7].nControlID=IDC_EDIT_GENERAL_8;
  m_DefaultData[7].szBuf.Format(TEXT("%d"),m_CustomGeneral.cbEndTime);
  m_DefaultData[8].nControlID=IDC_EDIT_GENERAL_10;
  m_DefaultData[8].szBuf.Format(TEXT("%I64d"),m_CustomGeneral.lAreaLimitScore);
  m_DefaultData[9].nControlID=IDC_EDIT_GENERAL_11;
  m_DefaultData[9].szBuf.Format(TEXT("%I64d"),m_CustomGeneral.lUserLimitScore);
  m_DefaultData[10].nControlID=IDC_EDIT_GENERAL_12;
  m_DefaultData[10].szBuf.Format(TEXT("%I64d"),m_CustomGeneral.lEndGameMul);
  m_DefaultData[11].nControlID=IDC_EDIT_GENERAL_13;
  m_DefaultData[11].szBuf.Format(TEXT("%s"),m_CustomGeneral.szMessageItem1);
  m_DefaultData[12].nControlID=IDC_EDIT_GENERAL_14;
  m_DefaultData[12].szBuf.Format(TEXT("%s"),m_CustomGeneral.szMessageItem2);
  m_DefaultData[13].nControlID=IDC_EDIT_GENERAL_15;
  m_DefaultData[13].szBuf.Format(TEXT("%s"),m_CustomGeneral.szMessageItem3);
  m_DefaultData[14].nControlID=IDC_EDIT_GENERAL_16;
  m_DefaultData[14].szBuf.Format(TEXT("%I64d"),m_CustomGeneral.StorageStart);
  m_DefaultData[15].nControlID=IDC_EDIT_GENERAL_17;
  m_DefaultData[15].szBuf.Format(TEXT("%I64d"),m_CustomGeneral.StorageDeduct);
  m_DefaultData[16].nControlID=IDC_EDIT_GENERAL_18;
  m_DefaultData[16].szBuf.Format(TEXT("%I64d"),m_CustomGeneral.StorageMax1);
  m_DefaultData[17].nControlID=IDC_EDIT_GENERAL_19;
  m_DefaultData[17].szBuf.Format(TEXT("%I64d"),m_CustomGeneral.StorageMul1);
  m_DefaultData[18].nControlID=IDC_EDIT_GENERAL_20;
  m_DefaultData[18].szBuf.Format(TEXT("%I64d"),m_CustomGeneral.StorageMax2);
  m_DefaultData[19].nControlID=IDC_EDIT_GENERAL_21;
  m_DefaultData[19].szBuf.Format(TEXT("%I64d"),m_CustomGeneral.StorageMul2);
  return TRUE;
}


BOOL CDlgCustomGeneral::OnCommand(WPARAM wParam, LPARAM lParam)
{
  // TODO: 在此添加专用代码和/或调用基类
  if(HIWORD(wParam) == EN_KILLFOCUS)
  {
    int nControlID = (int)LOWORD(wParam);
    CString cs;
    GetDlgItem(nControlID)->GetWindowText(cs);

    if(cs.IsEmpty() == TRUE)
    {
      for(int i=0; i<CountArray(m_DefaultData); i++)
      {
        if(m_DefaultData[i].nControlID == nControlID)
        {
          SetDlgItemText(nControlID,m_DefaultData[i].szBuf);
        }
      }
    }
...
{
  __super::OnInitDialog();
  m_DefaultData[0].nControlID=IDC_EDIT_ANDROID_1;
  m_DefaultData[0].szBuf.Format(TEXT("%I64d"),m_CustomAndroid.lRobotBankerCountMin);
  m_DefaultData[1].nControlID=IDC_EDIT_ANDROID_2;
  m_DefaultData[1].szBuf.Format(TEXT("%I64d"),m_CustomAndroid.lRobotBankerCountMax);
  m_DefaultData[2].nControlID=IDC_EDIT_ANDROID_3;
  m_DefaultData[2].szBuf.Format(TEXT("%I64d"),m_CustomAndroid.lRobotListMinCount);
  m_DefaultData[3].nControlID=IDC_EDIT_ANDROID_4;
  m_DefaultData[3].szBuf.Format(TEXT("%I64d"),m_CustomAndroid.lRobotListMaxCount);
  m_DefaultData[4].nControlID=IDC_EDIT_ANDROID_5;
  m_DefaultData[4].szBuf.Format(TEXT("%I64d"),m_CustomAndroid.lRobotApplyBanker);
  m_DefaultData[5].nControlID=IDC_EDIT_ANDROID_6;
  m_DefaultData[5].szBuf.Format(TEXT("%I64d"),m_CustomAndroid.lRobotWaitBanker);
  m_DefaultData[6].nControlID=IDC_EDIT_ANDROID_7;
  m_DefaultData[6].szBuf.Format(TEXT("%I64d"),m_CustomAndroid.lRobotMinBetTime);
  m_DefaultData[7].nControlID=IDC_EDIT_ANDROID_8;
  m_DefaultData[7].szBuf.Format(TEXT("%I64d"),m_CustomAndroid.lRobotMaxBetTime);
  m_DefaultData[8].nControlID=IDC_EDIT_ANDROID_9;
  m_DefaultData[8].szBuf.Format(TEXT("%I64d"),m_CustomAndroid.lRobotMinJetton);
  m_DefaultData[9].nControlID=IDC_EDIT_ANDROID_10;
  m_DefaultData[9].szBuf.Format(TEXT("%I64d"),m_CustomAndroid.lRobotMaxJetton);
  m_DefaultData[10].nControlID=IDC_EDIT_ANDROID_11;
  m_DefaultData[10].szBuf.Format(TEXT("%I64d"),m_CustomAndroid.lRobotBetMinCount);
  m_DefaultData[11].nControlID=IDC_EDIT_ANDROID_12;
  m_DefaultData[11].szBuf.Format(TEXT("%I64d"),m_CustomAndroid.lRobotBetMaxCount);
  m_DefaultData[12].nControlID=IDC_EDIT_ANDROID_13;
  m_DefaultData[12].szBuf.Format(TEXT("%I64d"),m_CustomAndroid.lRobotAreaLimit);
  m_DefaultData[13].nControlID=IDC_EDIT_ANDROID_14;
  m_DefaultData[13].szBuf.Format(TEXT("%I64d"),m_CustomAndroid.lRobotScoreMin);
  m_DefaultData[14].nControlID=IDC_EDIT_ANDROID_15;
  m_DefaultData[14].szBuf.Format(TEXT("%I64d"),m_CustomAndroid.lRobotScoreMax);
  m_DefaultData[15].nControlID=IDC_EDIT_ANDROID_16;
  m_DefaultData[15].szBuf.Format(TEXT("%I64d"),m_CustomAndroid.lRobotBankGetMin);
  m_DefaultData[16].nControlID=IDC_EDIT_ANDROID_17;
  m_DefaultData[16].szBuf.Format(TEXT("%I64d"),m_CustomAndroid.lRobotBankGetMax);
  m_DefaultData[17].nControlID=IDC_EDIT_ANDROID_18;
  m_DefaultData[17].szBuf.Format(TEXT("%I64d"),m_CustomAndroid.lRobotBankGetBankerMin);
  m_DefaultData[18].nControlID=IDC_EDIT_ANDROID_19;
  m_DefaultData[18].szBuf.Format(TEXT("%I64d"),m_CustomAndroid.lRobotBankGetBankerMax);
  m_DefaultData[19].nControlID=IDC_EDIT_ANDROID_20;
  m_DefaultData[19].szBuf.Format(TEXT("%II64d"),m_CustomAndroid.lRobotBankStoMul);
  return TRUE;
}
...
BOOL CDlgCustomAndroid::OnCommand(WPARAM wParam, LPARAM lParam)
{
  // TODO: 在此添加专用代码和/或调用基类
  if(HIWORD(wParam) == EN_KILLFOCUS)
  {
