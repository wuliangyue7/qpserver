...
//机器定义
#ifndef _DEBUG
#define ANDROID_SERVICE_DLL_NAME  TEXT("ZodiacBattleAndroid.dll") //组件名字
#else
#define ANDROID_SERVICE_DLL_NAME  TEXT("ZodiacBattleAndroid.dll") //组件名字
#endif
...
CGameServiceManager::CGameServiceManager(void)
{
  ...
  lstrcpyn(m_GameServiceAttrib.szClientEXEName,TEXT("ZodiacBattle.EXE"),CountArray(m_GameServiceAttrib.szClientEXEName));
  lstrcpyn(m_GameServiceAttrib.szServerDLLName,TEXT("ZodiacBattleServer.DLL"),CountArray(m_GameServiceAttrib.szServerDLLName));
...
HWND CGameServiceManager::CreateCustomRule(CWnd * pParentWnd, CRect rcCreate, LPBYTE pcbCustomRule, WORD wCustonSize)
{
  ...
  //默认配置
  if(!m_DlgCustomRule.CheckCustomRule())
  {
