...
void CGameClientView::DrawBankerInfo(CDC *pDC,int nWidth,int nHeight)
{
  ...
  {
    myprintf(Text,256,_TEXT("%s"),pClientUserItem==NULL?(TEXT("系统坐庄")):pClientUserItem->GetNickName());
  ...
  {
    myprintf(Text,256,_TEXT("%s"),pClientUserItem==NULL?(TEXT("无人坐庄")):pClientUserItem->GetNickName());
    //pDC->DrawText(Text, StrRect, DT_END_ELLIPSIS | DT_CENTER | DT_TOP|DT_SINGLELINE );
