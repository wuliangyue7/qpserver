...
VOID CGameLogic::DeduceWinner(int *nWinMultiple,BYTE *cbDiceValue)
{
  ...
  {
    if(analyseResult.cbAllDiceValue>=11&&analyseResult.cbAllDiceValue<=17)
    {
      nWinMultiple[0]=1;
    }
    if(analyseResult.cbAllDiceValue>=4&&analyseResult.cbAllDiceValue<=10)
    {
      nWinMultiple[1]=1;
    }
  }
  ...
  {
    if(analyseResult.cbAllDiceValue%2==0)
    {
      nWinMultiple[51]=1;
    }
    if(analyseResult.cbAllDiceValue%2==1)
    {
      nWinMultiple[50]=1;
    }
  }
