...
private:
  ...
  //设置函数
public:
  void SetFlashArea(BYTE cbFlashArea)
  {
    m_cbAreaFlash=cbFlashArea;
  }
  //我的位置
  ...
  //庄家成绩
  void SetBankerScore(WORD wBankerTime, SCORE lWinScore)
  {
  ...
  void OnBankStorage();
  //设置状态
  void SetGameStatus(BYTE cbStatus)
  {
    m_cbGameStatus=cbStatus;
  }
  BYTE GetClientViewStatus()
  {
