...
CAndroidUserItemSink::CAndroidUserItemSink()
{
  ...
  if(m_lRobotBetLimit[1] > 10000000)
  {
    m_lRobotBetLimit[1] = 10000000;
  }
  if(m_lRobotBetLimit[0] < 100)
  {
    m_lRobotBetLimit[0] = 100;
  }
  if(m_lRobotBetLimit[1] < m_lRobotBetLimit[0])
  {
    m_lRobotBetLimit[1] = m_lRobotBetLimit[0];
  }
...
void CAndroidUserItemSink::ReadConfigInformation(tagCustomAndroid *pCustomAndroid)
{
  ...
  if(m_lRobotBetLimit[0] < 1000)
  {
    m_lRobotBetLimit[0] = 1000;
  }
  if(m_lRobotBetLimit[1] < m_lRobotBetLimit[0])
  {
    m_lRobotBetLimit[1] = m_lRobotBetLimit[0];
