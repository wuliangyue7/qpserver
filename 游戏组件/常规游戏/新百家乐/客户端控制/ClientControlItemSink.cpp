...
BOOL CClientControlItemSinkDlg::OnInitDialog()
{
  ...
  m_listUserBet.InsertColumn(nColumnCount++,TEXT("闲"),LVCFMT_CENTER,60);
  m_listUserBet.InsertColumn(nColumnCount++,TEXT("平"),LVCFMT_CENTER,60);
  m_listUserBet.InsertColumn(nColumnCount++,TEXT("庄"),LVCFMT_CENTER,60);
  m_listUserBet.InsertColumn(nColumnCount++,TEXT("闲对子"),LVCFMT_CENTER,60);
  m_listUserBet.InsertColumn(nColumnCount++,TEXT("庄对子"),LVCFMT_CENTER,60);
  m_listUserBet.InsertColumn(nColumnCount++,TEXT("闲天王"),LVCFMT_CENTER,60);
  m_listUserBet.InsertColumn(nColumnCount++,TEXT("庄天王"),LVCFMT_CENTER,60);
  m_listUserBet.InsertColumn(nColumnCount++,TEXT("同点平"),LVCFMT_CENTER,60);
