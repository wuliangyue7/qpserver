...
VOID CCardControl::GetCenterPoint(CPoint & CenterPoint)
{
  ...
  switch(m_XCollocateMode)
  {
    case enXLeft:
    {
      CenterPoint.x=m_BenchmarkPos.x + ControlSize.cx/2;
      break;
    }
    case enXCenter:
    {
      CenterPoint.x=m_BenchmarkPos.x;
      break;
    }
    case enXRight:
    {
  ...
  switch(m_YCollocateMode)
  {
    case enYTop:
    {
      CenterPoint.y=m_BenchmarkPos.y + ControlSize.cy/2;
      break;
    }
    case enYCenter:
    {
      CenterPoint.y=m_BenchmarkPos.y ;
      break;
    }
    case enYBottom:
    {
