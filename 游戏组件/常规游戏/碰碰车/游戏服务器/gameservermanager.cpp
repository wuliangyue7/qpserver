...
//机器定义
#ifndef _DEBUG
#define ANDROID_SERVICE_DLL_NAME  TEXT("BumperCarBattleAndroid.dll")  //组件名字
#else
#define ANDROID_SERVICE_DLL_NAME  TEXT("BumperCarBattleAndroid.dll")  //组件名字
#endif
...
CGameServiceManager::CGameServiceManager(void)
{
  ...
  lstrcpyn(m_GameServiceAttrib.szClientEXEName,TEXT("BumperCarBattle.exe"),CountArray(m_GameServiceAttrib.szClientEXEName));
  lstrcpyn(m_GameServiceAttrib.szServerDLLName,TEXT("BumperCarBattleServer.DLL"),CountArray(m_GameServiceAttrib.szServerDLLName));
...
HWND CGameServiceManager::CreateCustomRule(CWnd * pParentWnd, CRect rcCreate, LPBYTE pcbCustomRule, WORD wCustonSize)
{
  ...
  {
    //设置资源
    AfxSetResourceHandle(GetModuleHandle(m_GameServiceAttrib.szServerNameDLLName));
