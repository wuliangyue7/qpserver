...
#define WM_SET_CAPTION        WM_USER+209                      //设置标题消息
//索引定义
...
protected:
  ...
  int               m_LifeWidth;
  int               m_CurArea;
  LONGLONG                        m_lUserScoreTotal[GAME_PLAYER];//每个选手房间的总赢输
  //机器人下注
...
protected:
  ...
  CPngImageEx                        m_ImaNumberBack;                 //数字底图
  CPngImageEx             m_PngFrameTianMen;        //边框图片
  CPngImageEx             m_PngFrameTianMen1;       //边框图片
  CPngImageEx             m_PngFrameTianMen2;       //边框图片
  CPngImageEx             m_PngFrameTianMen3;       //边框图片
  CPngImageEx             m_PngFrameTianMen4;       //边框图片
  CPngImageEx             m_PngFrameTianMen5;       //边框图片
  CPngImageEx             m_PngFrameTianMen6;       //边框图片
  CPngImageEx             m_PngFrameTianMen7;       //边框图片
...
public:
  ...
  int m_EllipseX;  // 下注左弧线的横坐标

  int m_EllipseY;  // 下注左弧线的纵坐标
  //动画函数
public:
  //开始发牌
  void DispatchCard();
...
public:
  ...
  void SetUserTotal(LONGLONG lUserScoreTotal,WORD wChair); //设置每一个人房间总得分
  //内联函数
public:
  //当前筹码
