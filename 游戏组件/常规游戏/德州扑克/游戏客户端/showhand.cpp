...
{
  //加载资源
  m_ImageBack.LoadFromResource(AfxGetInstanceHandle(),IDB_SHOWHAND_COMFIRE);
  m_bTimes = 0;
}
...
BOOL ShowHand::OnInitDialog()
{
  ...
  m_btOK.SetButtonImage(IDB_BT_YES1,Hinstance,false,false);
  m_btCancel.SetButtonImage(IDB_BT_NO1,Hinstance,false,false);
...
void ShowHand::OnPaint()
{
  ...
  //绘画背景
  m_ImageBack.TransDrawImage(&dc,0,0,RGB(255,255,255));
  ...
  TCHAR tCh[128]=TEXT("");
  _sntprintf(tCh,sizeof(tCh),TEXT("%ld"),m_bTimes);
