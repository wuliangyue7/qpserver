...
//机器定义
#ifndef _DEBUG
#define ANDROID_SERVICE_DLL_NAME  TEXT("ShuangKouHPAndroid.dll")  //组件名字
#else
#define ANDROID_SERVICE_DLL_NAME  TEXT("ShuangKouHPAndroid.dll")  //组件名字
#endif
...
CGameServiceManager::CGameServiceManager(void)
{
  ...
  lstrcpyn(m_GameServiceAttrib.szClientEXEName,TEXT("ShuangKouHP.exe"),CountArray(m_GameServiceAttrib.szClientEXEName));
  lstrcpyn(m_GameServiceAttrib.szServerDLLName,TEXT("ShuangKouHPServer.dll"),CountArray(m_GameServiceAttrib.szServerDLLName));
...
bool CGameServiceManager::RectifyParameter(tagGameServiceOption & GameServiceOption)
{
  ...
  {
    GameServiceOption.lMinTableScore=__max(GameServiceOption.lCellScore*15L,GameServiceOption.lMinTableScore);
  }
