#ifndef CARD_CONTROLEX_HEAD_FILE
#define CARD_CONTROLEX_HEAD_FILE
...
//扑克控件
class CCardControlEx : public CWnd
{
  //配置变量
protected:
...
public:
  ...
  //设置模式
  void SetSmallCard(bool bSmallCard) ;
