...
CCardControl::CCardControl()
{
  ...
  //加载资源
  //m_ImageCard.LoadImage(AfxGetInstanceHandle(),TEXT("HAND_CARD"));
...
bool CCardControl::SetCardData(const BYTE cbCardData[], WORD wCardCount)
{
  ...
  if(wCardCount>CountArray(m_CardItem))
  {
    return false;
  }
...
VOID CCardControl::DrawCardControl(CDC * pDC)
{
  ...
  else
  {
    ...
    //m_ImageCard.DrawImage( pDC,OriginPoint.x,OriginPoint.y-nYMove,m_CardSize.cx,m_CardSize.cy,nXImagePos,nYImagePos );
    m_ImageCard.TransDrawImage(pDC,OriginPoint.x,OriginPoint.y-nYMove,m_CardSize.cx,m_CardSize.cy,nXImagePos,nYImagePos,RGB(255,0,255));
    nXImagePos=m_CardSize.cx*2;
    nYImagePos=m_CardSize.cy*4;
    //m_ImageCard.DrawImage( pDC,OriginPoint.x,OriginPoint.y,m_CardSize.cx,m_CardSize.cy,nXImagePos,nYImagePos );
    m_ImageCard.TransDrawImage(pDC,OriginPoint.x,OriginPoint.y,m_CardSize.cx,m_CardSize.cy,nXImagePos,nYImagePos,RGB(255,0,255));
  }
