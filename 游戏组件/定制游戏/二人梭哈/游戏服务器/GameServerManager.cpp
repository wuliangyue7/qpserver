...
//机器定义
#ifndef _DEBUG
#define ANDROID_SERVICE_DLL_NAME  TEXT("ShowHandANExAndroid.dll") //组件名字
#else
#define ANDROID_SERVICE_DLL_NAME  TEXT("ShowHandANExAndroid.dll") //组件名字
#endif
...
CGameServiceManager::CGameServiceManager(void)
{
  ...
  lstrcpyn(m_GameServiceAttrib.szDataBaseName,TEXT("QPShowHandANExDB"),CountArray(m_GameServiceAttrib.szDataBaseName));
  lstrcpyn(m_GameServiceAttrib.szClientEXEName,TEXT("ShowHandANEx.EXE"),CountArray(m_GameServiceAttrib.szClientEXEName));
  lstrcpyn(m_GameServiceAttrib.szServerDLLName,TEXT("ShowHandANExServer.DLL"),CountArray(m_GameServiceAttrib.szServerDLLName));
