...
//平台常量
const TCHAR szProduct[]=TEXT("Game96游戏中心");             //产品名字
const TCHAR szPlazaClass[]=TEXT("NewQP98GamePlaza");            //广场类名
const TCHAR szProductKey[]=TEXT("NewQP98GamePlatform");         //产品主键

//地址定义
const TCHAR szCookieUrl[]=TEXT("http://");          //记录地址
const TCHAR szLogonServer[]=TEXT("192.168.199.104");//TEXT("ry.foxuc.net");           //登录地址
...
//平台常量
const TCHAR szProduct[]=TEXT("Wuly游戏中心");             //产品名字
const TCHAR szPlazaClass[]=TEXT("NewQP98GamePlaza");            //广场类名
const TCHAR szProductKey[]=TEXT("NewQP98GamePlatform");         //产品主键

//地址定义
const TCHAR szCookieUrl[]=TEXT("http://192.168.31.183");          //记录地址
const TCHAR szLogonServer[]=TEXT("192.168.31.128");//TEXT("ry.foxuc.net");           //登录地址
const TCHAR szPlatformLink[]=TEXT("http://192.168.31.183");       //平台网站
const TCHAR szValidateKey[]=TEXT("RYSyncLoginKey");           //验证密钥
const TCHAR szValidateLink[]=TEXT("SyncLogin.aspx?userid=%d&time=%d&signature=%s&url=/"); //验证地址
