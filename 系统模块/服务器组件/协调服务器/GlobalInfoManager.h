...
public:
  ...
  BYTE GetMemberOrder()
  {
    return m_cbMemberOrder;
  }
  //会员等级
  BYTE GetMasterOrder()
  {
    return m_cbMasterOrder;
  }
  //详细信息
...
public:
  ...
  //用户数目
  DWORD GetUserItemCount()
  {
    return (DWORD)m_MapUserID.GetCount();
  }
  //比赛房间
  bool IsMatchServer()
  {
    return (m_GameMatch.wServerID==m_GameServer.wServerID) && m_GameMatch.dwMatchID!=0;
  }
...
public:
  ...
  //大厅数目
  DWORD GetPlazaItemCount()
  {
    return (DWORD)m_MapPlazaID.GetCount();
  }
  //房间数目
  DWORD GetServerItemCount()
  {
    return (DWORD)m_MapServerID.GetCount();
  }
  //聊天数目
  DWORD GetChatItemCount()
  {
    return (DWORD)m_MapChatID.GetCount();
  }
