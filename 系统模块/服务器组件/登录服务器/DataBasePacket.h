...
#define DBR_GP_LOAD_GAME_PROPERTY 69                  //加载道具
...
//道具命令
#define DBO_GP_GAME_PROPERTY_ITEM     300                 //道具节点
#define DBO_GP_GAME_PROPERTY_LIST_RESULT  301                 //道具结果
#define DBO_GP_GAME_PROPERTY_BUY  304                 //道具购买
#define DBO_GP_QUERY_BACKPACK   305                 //查询背包
#define DBO_GP_GAME_PROPERTY_USE  306                 //道具使用
#define DBO_GP_USER_PROPERTY_BUFF 307                 //道具Buff
#define DBO_GP_PROPERTY_PRESENT   308                 //道具赠送
#define DBO_GP_QUERY_SEND_PRESENT 309                 //查询赠送
#define DBO_GP_GET_SEND_PRESENT   310                 //获取赠送
...
//////////////////////////////////////////////////////////////////////////////////
//道具信息
struct DBO_GP_GamePropertyInfo
{
...
struct DBO_MB_LogonSuccess
{
  ...
  DWORD             dwExperience;           //经验数值
  DWORD             dwLoveLiness;           //用户魅力
  TCHAR             szAccount[LEN_ACCOUNTS];     //用户昵称
  TCHAR             szNickName[LEN_ACCOUNTS];     //用户昵称
  TCHAR             szDynamicPass[LEN_PASSWORD];    //动态密码
  TCHAR             szUnderWrite[LEN_UNDER_WRITE];    //个性签名
