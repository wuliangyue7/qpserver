...
namespace NServerListManager
{
  ...
  public:
    ...
    {
      return (DWORD)m_TypeItemMap.GetCount();
    }
    //类型数目
    DWORD GetGameKindCount()
    {
      return (DWORD)m_KindItemMap.GetCount();
    }
    //节点数目
    DWORD GetGameNodeCount()
    {
      return (DWORD)m_NodeItemMap.GetCount();
    }
    //定制数目
    DWORD GetGamePageCount()
    {
      return (DWORD)m_PageItemMap.GetCount();
    }
    //房间数目
    DWORD GetGameServerCount()
    {
      return (DWORD)m_ServerItemMap.GetCount();
    }
  };
