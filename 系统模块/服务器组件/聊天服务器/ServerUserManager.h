...
public:
  //获取类型
  enUserItemKind GetUserItemKind()
  {
    return m_enUserKind;
  }
};
...
public:
  //用户信息
  virtual tagFriendUserInfo * GetUserInfo()
  {
    return &m_UserInfo;
  }
...
public:
  //修改状态
  virtual VOID SetMainStatus(BYTE cbMainStatus)
  {
    m_UserInfo.cbMainStatus=cbMainStatus;
  }
  //设置状态
  ...
  //用户状态
  virtual BYTE GetMainStatus()
  {
    return m_UserInfo.cbMainStatus;
  }
  //用户状态
  virtual BYTE GetGameStatus()
  {
    return m_UserInfo.cbGameStatus;
  }
  //连接地址
  virtual DWORD GetClientAddr()
  {
    return m_UserInfo.dwClientAddr;
  }
...
public:
  ...
  //设置标识
  virtual VOID SetSocketID(DWORD dwSocketID)
  {
...
public:
  ...
  //设置时间
  virtual VOID SetLogonTime(DWORD dwLogonTime)
  {
    m_dwLogonTime=dwLogonTime;
  }
...
public:
  //设置标识
  VOID SetOwnerUserID(DWORD dwUserID)
  {
    m_dwOwnerUserID=dwUserID;
  }
  //获取标识
  DWORD GetOwnerUserID()
  {
    return m_dwOwnerUserID;
  }
  //获取容量
  WORD GetGroupContent()
  {
    return m_wGroupContent;
  }
  //获取数目
  WORD GetFriendCount()
  {
    return m_wFriendCount;
  }
