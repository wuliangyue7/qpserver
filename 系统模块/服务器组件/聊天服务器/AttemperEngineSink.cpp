...
bool CAttemperEngineSink::OnEventTCPSocketSubUserStatus(VOID * pData, WORD wDataSize)
{
  ...
  if(wDataSize!=sizeof(CMD_CS_S_UserGameStatus))
  {
    return false;
  }
...
bool CAttemperEngineSink::OnEventTCPNetworkShut(DWORD dwClientAddr, DWORD dwActiveTime, DWORD dwSocketID)
{
  ...
  try
  {
    ...
    {
      //状态判断
      if(pServerUserItem->GetMainStatus()==FRIEND_US_OFFLINE)
      {
        return true;
      }
...
bool CAttemperEngineSink::OnTCPNetworkSubMBLogonByUserID(VOID * pData, WORD wDataSize, DWORD dwSocketID)
{
  ...
  if(wDataSize>sizeof(CMD_GC_MB_LogonByUserID))
  {
    return false;
  }
...
bool CAttemperEngineSink::OnTCPNetworkSubApplyForFriend(VOID * pData, WORD wDataSize, DWORD dwSocketID)
{
  ...
  if(wDataSize!=sizeof(CMD_GC_ApplyForFriend))
  {
    return false;
  }
  ...
  if(pFriendUserItem && pFriendUserItem->GetMainStatus()==FRIEND_US_OFFLINE)
  {
    bBufferMessage=true;
  }
...
bool CAttemperEngineSink::OnTCPNetworkSubRespondFriend(VOID * pData, WORD wDataSize, DWORD dwSocketID)
{
  ...
  if(wDataSize!=sizeof(CMD_GC_RespondFriend))
  {
    return false;
  }
  ...
  else
  {
    ...
    if(pRequestUserItem && pRequestUserItem->GetMainStatus()==FRIEND_US_OFFLINE)
    {
      bBufferMessage=true;
    }
...
bool CAttemperEngineSink::OnTCPNetworkSubRoomInvite(VOID * pData, WORD wDataSize, DWORD dwSocketID)
{
  ...
  if(wDataSize>sizeof(CMD_GC_InviteGame))
  {
    return false;
  }
  ...
  //发送数据
  WORD wSize = sizeof(VipRoomInviteNotify)-sizeof(VipRoomInviteNotify.szInviteMsg)+CountStringBuffer(VipRoomInviteNotify.szInviteMsg);
...
bool CAttemperEngineSink::OnTCPNetworkSubUserChat(VOID * pData, WORD wDataSize, DWORD dwSocketID)
{
  ...
  if(wDataSize>sizeof(CMD_GC_UserChat))
  {
    return false;
  }
...
bool CAttemperEngineSink::OnTCPNetworkSubSearchUser(VOID * pData, WORD wDataSize, DWORD dwSocketID)
{
  ...
  if(wDataSize>sizeof(CMD_GC_SearchByGameID))
  {
    return false;
  }
...
bool CAttemperEngineSink::OnTCPNetworkSubTrumpet(VOID * pData, WORD wDataSize, DWORD dwSocketID)
{
  ...
  if(wDataSize>sizeof(CMD_GC_Trumpet))
  {
    return false;
  }
  ...
  Trumpet.cbFontAttri = pUserChat->cbFontAttri;
  Trumpet.cbFontSize = pUserChat->cbFontSize;
  Trumpet.dwFontColor = pUserChat->dwFontColor;
  Trumpet.dwSourceUserID = pUserChat->dwSenderID;
  Trumpet.dwClientAddr =pBindParameter->dwClientAddr;

  lstrcpyn(Trumpet.szNickName, pUserChat->szNickName, CountArray(Trumpet.szNickName));
  lstrcpyn(Trumpet.szFontName, pUserChat->szFontName, CountArray(Trumpet.szFontName));
  lstrcpyn(Trumpet.szMessageContent, pUserChat->szMessageContent, CountArray(Trumpet.szMessageContent));
...
bool CAttemperEngineSink::OnTCPNetworkDeleteFriend(VOID * pData, WORD wDataSize, DWORD dwSocketID)
{
  ...
  if(wDataSize>sizeof(CMD_GC_DeleteFriend))
  {
    return false;
  }
...
bool CAttemperEngineSink::OnDBLogonSuccess(DWORD dwContextID, VOID * pData, WORD wDataSize)
{
  ...
  if(wDataSize>sizeof(DBO_GR_LogonSuccess))
  {
    return false;
  }
...
bool CAttemperEngineSink::OnDBLoadUserGroup(DWORD dwContextID, VOID * pData, WORD wDataSize)
{
  ...
  if(wDataSize>sizeof(DBO_GR_UserGroupInfo))
  {
    return false;
  }
...
bool CAttemperEngineSink::OnDBLoadUserFriend(DWORD dwContextID, VOID * pData, WORD wDataSize)
{
  ...
  if(wDataSize>sizeof(DBO_GR_UserFriendInfo))
  {
    return false;
  }
...
bool CAttemperEngineSink::OnDBLoadUserRemarksInfo(DWORD dwContextID, VOID * pData, WORD wDataSize)
{
  ...
  if(wDataSize>sizeof(DBO_GR_UserRemarksInfo))
  {
    return false;
  }
...
bool CAttemperEngineSink::OnDBLoadUserSimpleIndividual(DWORD dwContextID, VOID * pData, WORD wDataSize)
{
  ...
  if(wDataSize>sizeof(DBO_GR_UserIndividual))
  {
    return false;
  }
...
bool CAttemperEngineSink::OnDBLoadUserOfflineMessage(DWORD dwContextID, VOID * pData, WORD wDataSize)
{
  ...
  if(wDataSize>sizeof(DBO_GR_UserOfflineMessage))
  {
    return false;
  }
  ...
  if(pUserUserOfflineMessage->szOfflineData[0]!=0)
  {
    ...
    for(INT i=0; i<nCustomRuleSize; i++)
    {
      ...
      {
        cbOfflineData[i]+=(cbChar2-TEXT('0'));
      }
      if((cbChar2>=TEXT('A'))&&(cbChar2<=TEXT('F')))
      {
        cbOfflineData[i]+=(cbChar2-TEXT('A')+0x0A);
      }

      //生成结果
      if((cbChar1>=TEXT('0'))&&(cbChar1<=TEXT('9')))
      {
        cbOfflineData[i]+=(cbChar1-TEXT('0'))*0x10;
      }
      if((cbChar1>=TEXT('A'))&&(cbChar1<=TEXT('F')))
      {
        cbOfflineData[i]+=(cbChar1-TEXT('A')+0x0A)*0x10;
      }
    }
  }
...
bool CAttemperEngineSink::OnDBLoadDeleteFriend(DWORD dwContextID, VOID * pData, WORD wDataSize)
{
  ...
  if(wDataSize>sizeof(DBO_GR_DeleteFriend))
  {
    return false;
  }
...
bool CAttemperEngineSink::OnDBSearchUserResult(DWORD dwContextID, VOID * pData, WORD wDataSize)
{
  ...
  if(wDataSize>sizeof(DBO_GR_SearchUserResult))
  {
    return false;
  }
...
bool CAttemperEngineSink::OnDBUserAddFriend(DWORD dwContextID, VOID * pData, WORD wDataSize)
{
  ...
  if(wDataSize!=sizeof(DBO_GR_AddFriend))
  {
    return false;
  }
...
bool CAttemperEngineSink::OnDBTrumpetResult(DWORD dwContextID, VOID * pData, WORD wDataSize)
{
  ...
  if(wDataSize!=sizeof(DBO_GR_TrumpetResult))
  {
    return false;
  }
  ...
  if(pTrumpetResult->lResult == 0)
  {
    ...
    Trumpet.dwSenderID = pTrumpetResult->dwSourceUserID;
    Trumpet.cbFontAttri = pTrumpetResult->cbFontAttri;
    Trumpet.cbFontSize = pTrumpetResult->cbFontSize;
    Trumpet.dwFontColor = pTrumpetResult->dwFontColor;
    lstrcpyn(Trumpet.szNickName, pTrumpetResult->szNickName, CountArray(Trumpet.szNickName));
    lstrcpyn(Trumpet.szFontName, pTrumpetResult->szFontName, CountArray(Trumpet.szFontName));
    lstrcpyn(Trumpet.szMessageContent, pTrumpetResult->szMessageContent, CountArray(Trumpet.szMessageContent));


    //广播数据
    m_pITCPNetworkEngine->SendDataBatch(MDM_GC_USER,SUB_GC_TRUMPET_NOTIFY,&Trumpet,sizeof(Trumpet),0xFF);
  }
  else
  {
    //喇叭反馈
...
bool CAttemperEngineSink::OnDBUserOperateResult(DWORD dwContextID, VOID * pData, WORD wDataSize)
{
  ...
  if(wDataSize>sizeof(DBO_GR_OperateResult))
  {
    return false;
  }
