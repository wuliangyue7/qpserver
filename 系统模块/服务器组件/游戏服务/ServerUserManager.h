...
public:
  ...
  //用户成绩
  virtual SCORE GetUserToDayGradeScore()
  {
    return m_UserInfo.lToDayGradeScore;
  }
  //用户成绩
  virtual SCORE GetUserTolGrade()
  {
    return m_UserInfo.lTolGrade;
  }
  //用户成绩
  virtual SCORE GetUserTolToDayGrade()
  {
    return m_UserInfo.lTolToDayGrade;
  }
  //用户银行
...
public:
  ...
  {
    return m_cbMatchStatus;
  }
  //比赛状态
  virtual VOID SetUserMatchStatus(BYTE cbMatchStatus);
  //设置状态
  virtual bool SetUserStatusEx(BYTE cbUserStatusEx, WORD wTableID, WORD wChairID);
  virtual BYTE GetUserStatusEx()
  {
    return m_UserInfo.cbUserStatusEx;
  }
  //用户组 I D
  virtual bool  SetTeamID(WORD wTeamID);
  //用户排名
  virtual bool  SetSortID(WORD wSortID);
