...
INT CServerListControl::SortListItemData(LPARAM lParam1, LPARAM lParam2, WORD wColumnIndex)
{
  ...
  if(bInstall1!=bInstall2)
  {
    return (bInstall1==true)?1:-1;
  }
  ...
  switch(wColumnIndex)
  {
    ...
    case 6:   //类型标识
    {
      ...
      if(wKindID1==0)
      {
        wKindID1=pGameServerInfo1->wGameID;
      }
      ...
      if(wKindID2==0)
      {
        wKindID2=pGameServerInfo2->wGameID;
      }
...
LPCTSTR CServerListControl::GetDescribeString(tagGameServerInfo * pGameServerInfo, WORD wColumnIndex)
{
  ...
  switch(wColumnIndex)
  {
    ...
    case 4:   //监听端口
    {
      if(pGameServerInfo->wServerPort==0)
      {
        return TEXT("-");
      }
