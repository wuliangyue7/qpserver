...
protected:
  ...
  //在线人数
  bool OnRequestUpdateOnlineCount(DWORD dwContextID, VOID * pData, WORD wDataSize, DWORD &dwUserID);
  //库存数据
  bool OnRequestLoadStorageConfigInfo(DWORD dwContextID, VOID * pData, WORD wDataSize, DWORD &dwUserID);
  //库存数据
  bool OnRequestUpdateStorageConfigInfo(DWORD dwContextID, VOID * pData, WORD wDataSize, DWORD &dwUserID);
