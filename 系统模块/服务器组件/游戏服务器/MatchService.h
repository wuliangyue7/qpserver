...
public:
  ...
  //报名人数
  virtual DWORD GetSignUpUserCount()
  {
    return (DWORD)m_ServerUserItemMap.GetCount();
  }
  //设置规则
  virtual VOID  SetDistributeRule(BYTE cbDistributeRule)
  {
    m_DistributeManage.SetDistributeRule(cbDistributeRule);
  }
  //插入分配
...
public:
  ...
  //游戏开始
  virtual bool OnEventGameStart(WORD wTableID)
  {
    return true;
  }
  //游戏结束
