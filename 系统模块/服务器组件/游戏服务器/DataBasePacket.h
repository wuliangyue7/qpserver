...
#define DBR_GR_UPDATE_ONLINE_COUNT  311                                 //更新人数
#define DBR_GR_LOAD_STORAGE_CONFIG_INFO   312                                 //库存数据
#define DBR_GR_UPDATE_STORAGE_CONFIG_INFO   313                                 //库存数据
...
#define DBR_GR_LOAD_STORAGE_CONFIG_INFO_RESULT    205                                 //库存数据
...
#define DBO_GR_GAME_PROPERTY_LIST_RESULT  221             //道具信息
//银行命令
...
//更新在线人数
struct DBO_GR_UpdateOnLineCount
{
  WORD                             wServerID;                          //房间I D
  WORD                             wKindID;                            //房间I D
  DWORD                            dwOnLineCount;                      //在线人数
  DWORD                            dwMBOnLineCount;                      //在线人数
};
//库存操作数据
struct DBO_GR_StorageConfigInfo
{
  WORD                             wServerID;                          //房间I D
  WORD                             wKindID;                            //房间I D
