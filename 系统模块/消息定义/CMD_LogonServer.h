...
#define SUB_GP_PROPERTY_CONFIG    109                 //道具配置
#define SUB_GP_REAL_AUTH_CONFIG   110                 //认证配置
//升级提示
#define SUB_GP_UPDATE_NOTIFY    200                 //升级提示
#define SUB_GP_PROPERTY_CONFIG_FINISH 207               //道具配置
//////////////////////////////////////////////////////////////////////////////////
//
...
struct CMD_GP_RegisterAccounts
{
  ...
  int               nCode;
  //包秘钥
  TCHAR                           szDataEncrypt[LEN_MD5];             //数据秘钥
...
#define SUB_GP_QUERY_PROPERTY_RESULT_FINISH 201             //道具查询

#define SUB_GP_PROPERTY_FAILURE       404             //道具失败


//道具配置
struct CMD_GP_ConfigProperty
{
...
//道具成功
struct CMD_GP_S_PropertySuccess
{
  //购买信息
  DWORD             dwPropID;             //道具ID
