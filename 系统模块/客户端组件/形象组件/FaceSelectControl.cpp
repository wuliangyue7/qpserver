...
VOID CFaceItemSelectWnd::OnLButtonDown(UINT nFlags, CPoint Point)
{
  ...
  if(m_pIFaceItemSelectEvent!=NULL)
  {
    m_pIFaceItemSelectEvent->OnEventFaceSelect(m_wSelectFace);
  }
