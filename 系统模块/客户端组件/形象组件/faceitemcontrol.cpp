...
CFaceItemControl::CFaceItemControl()
{
  ...
  if(m_pFaceItemControl==NULL)
  {
    m_pFaceItemControl=this;
  }
...
CFaceItemControl::~CFaceItemControl()
{
  ...
  if(m_pFaceItemControl==this)
  {
    m_pFaceItemControl=NULL;
  }
...
VOID CFaceItemControl::DrawFaceItemFrame(CDC * pDC, INT nXPos, INT nYPos, BYTE cbFrameKind)
{
  ...
  if(cbFrameKind>ITEM_FRAME_HITDOWN)
  {
    return;
  }
