...
public:
  //获取类型
  enItemGenre GetItemGenre()
  {
    return m_ItemGenre;
  }
  //获取父项
  CGameListItem * GetParentListItem()
  {
...
public:
  //种类数目
  DWORD GetGameTypeCount()
  {
    return (DWORD)m_GameTypeItemMap.GetCount();
  }
  //类型数目
  DWORD GetGameKindCount()
  {
    return (DWORD)m_GameKindItemMap.GetCount();
  }
  //节点数目
  DWORD GetGameNodeCount()
  {
    return (DWORD)m_GameNodeItemMap.GetCount();
  }
  //定制数目
  DWORD GetGamePageCount()
  {
    return (DWORD)m_GamePageItemMap.GetCount();
  }
  //房间数目
  DWORD GetGameServerCount()
  {
    return (DWORD)m_GameServerItemMap.GetCount();
  }
