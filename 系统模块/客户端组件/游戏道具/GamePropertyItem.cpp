...
LPCTSTR CGamePropertyCrystal::GetNotifyMessage(LPCTSTR szSourceNickName,LPCTSTR szTargerNickName,WORD wItemCount,LPTSTR szResultMessage)
{
  ...
  if(szSourceNickName==szTargerNickName)
  {
    _sntprintf(szMessage,CountArray(szMessage),TEXT("恭喜您！道具使用成功，恭喜您获得%d游戏币！"),wItemCount*m_PropertyInfo.lUseResultsGold);
  }
  else
  {
    _sntprintf(szMessage,CountArray(szMessage),TEXT("恭喜您！[ %s ]玩家赠送了您的水晶，使用后将获得%d游戏币！"),szSourceNickName,wItemCount*m_PropertyInfo.lUseResultsGold);
  }
...
LPCTSTR CGamePropertyAgate::GetNotifyMessage(LPCTSTR szSourceNickName,LPCTSTR szTargerNickName,WORD wItemCount,LPTSTR szResultMessage)
{
  ...
  {
    _sntprintf(szMessage,CountArray(szMessage),TEXT("恭喜您！[ %s ]玩家赠送了您的玛瑙，使用后将获得%d游戏币！"),szSourceNickName,wItemCount*m_PropertyInfo.lUseResultsGold);
  }
...
LPCTSTR CGamePropertyBoulder::GetNotifyMessage(LPCTSTR szSourceNickName,LPCTSTR szTargerNickName,WORD wItemCount,LPTSTR szResultMessage)
{
  ...
  if(szSourceNickName==szTargerNickName)
  {
    _sntprintf(szMessage,CountArray(szMessage),TEXT("恭喜您！道具使用成功，玉石，恭喜您获得%d游戏币！"),wItemCount*m_PropertyInfo.lUseResultsGold);
  }
  else
  {
    _sntprintf(szMessage,CountArray(szMessage),TEXT("恭喜您！[ %s ]玩家赠送了您的玉石，使用后将获得%d游戏币！"),szSourceNickName,wItemCount*m_PropertyInfo.lUseResultsGold);
  }
...
LPCTSTR CGamePropertyGem::GetNotifyMessage(LPCTSTR szSourceNickName,LPCTSTR szTargerNickName,WORD wItemCount,LPTSTR szResultMessage)
{
  ...
  if(szSourceNickName==szTargerNickName)
  {
    _sntprintf(szMessage,CountArray(szMessage),TEXT("恭喜您！道具使用成功，宝石，恭喜您获得%d游戏币！"),wItemCount*m_PropertyInfo.lUseResultsGold);
  }
  else
  {
    _sntprintf(szMessage,CountArray(szMessage),TEXT("恭喜您！[ %s ]玩家赠送了您的宝石，使用后将获得%d游戏币！"),szSourceNickName,wItemCount*m_PropertyInfo.lUseResultsGold);
  }
...
LPCTSTR CGamePropertyDiamond::GetNotifyMessage(LPCTSTR szSourceNickName,LPCTSTR szTargerNickName,WORD wItemCount,LPTSTR szResultMessage)
{
  ...
  if(szSourceNickName==szTargerNickName)
  {
    _sntprintf(szMessage,CountArray(szMessage),TEXT("恭喜您！道具使用成功，钻石，恭喜您获得%d游戏币！"),wItemCount*m_PropertyInfo.lUseResultsGold);
  }
  else
  {
    _sntprintf(szMessage,CountArray(szMessage),TEXT("恭喜您！[ %s ]玩家赠送了您的钻石，使用后将获得%d游戏币！"),szSourceNickName,wItemCount*m_PropertyInfo.lUseResultsGold);
  }
