...
public:
  ...
  //自定头像
  virtual tagCustomFaceInfo * GetCustomFaceInfo()
  {
    return &m_CustomFaceInfo;
  }
  //道具包裹
  virtual tagPropertyPackage * GetPropertyPackage()
  {
...
public:
  //经验数值
  virtual DWORD GetUserExperience()
  {
    return m_UserInfo.dwExperience;
  }
  //魅力数值
  virtual LONG GetUserLoveLiness()
  {
...
public:
  //用户元宝
  virtual SCORE GetUserIngot()
  {
    return m_UserInfo.lIngot;
  }
  //积分数值
...
public:
  //胜利盘数
  virtual DWORD GetUserWinCount()
  {
    return m_UserInfo.dwWinCount;
  }
  //失败盘数
  virtual DWORD GetUserLostCount()
  {
    return m_UserInfo.dwLostCount;
  }
  //和局盘数
  virtual DWORD GetUserDrawCount()
  {
    return m_UserInfo.dwDrawCount;
  }
  //逃跑盘数
  virtual DWORD GetUserFleeCount()
  {
    return m_UserInfo.dwFleeCount;
  }
  //游戏局数
...
public:
  //获取关系
  virtual BYTE GetUserCompanion()
  {
    return m_cbCompanion;
  }
  //设置关系
  virtual VOID SetUserCompanion(BYTE cbCompanion)
  {
...
public:
  ...
  //获取备注
  virtual LPCTSTR GetUserNoteInfo()
  {
    return m_szUserNote;
  }
};
...
public:
  ...
  {
    return (DWORD)m_UserItemActive.GetCount();
  }
};
