...
VOID CDlgBagPresent::InitUI()
{
  ...
  {
    CStdString  csImageProp;
    csImageProp.Format(TEXT("DLG_BOX_SHOP\\GMAE_PROPERTY_%d.png"),m_BackpackProperty.Property.wIndex);
    pItemPropIOC->SetBkImage(csImageProp);
  }
