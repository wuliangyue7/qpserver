...
class CDlgSetup;
//////////////////////////////////////////////////////////////////////////////////
typedef CMD_GP_ConfigProperty ConfigProperty;
...
protected:
  ...
  //公用配置
protected:
  ConfigProperty          m_ConfigProperty;         //道具配置
...
public:
  //大厅版本
  virtual DWORD GetPlazaVersion()
  {
    return m_dwPlazaVersion;
  }
  //框架版本
  virtual DWORD GetFrameVersion()
  {
    return m_dwFrameVersion;
  }
...
public:
  ...
  //设置标识
  VOID SetTrackUserID(DWORD dwTrackUserID)
  {
    m_dwTrackUserID=dwTrackUserID;
  }
  //设置标识
  VOID SetTrackServerID(WORD wTrackServerID)
  {
    m_wTrackServerID=wTrackServerID;
  }
...
public:
  ...
  //设置配置
public:
  VOID ClearPropertyConfigInfo();
  VOID AddPropertyConfigItem(const tagPropertyInfo* pInfo, const BYTE cbCount = 1);
  VOID SetPropertyConfigInfo(const tagPropertyInfo* pInfo, const BYTE cbCount);
  const ConfigProperty* GetPropertyConfigInfo();
