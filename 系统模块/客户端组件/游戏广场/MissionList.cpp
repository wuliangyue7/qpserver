  ...
  if(Command.wMainCmdID==MDM_GP_SERVER_LIST)
  {
    switch(Command.wSubCmdID)
    {
      case SUB_GP_LIST_TYPE:    //种类信息
      {
        ...
        if(wDataSize%sizeof(tagGameType)!=0)
        {
          return false;
        }
      ...
      case SUB_GP_LIST_KIND:    //类型信息
      {
        ...
        if(wDataSize%sizeof(tagGameKind)!=0)
        {
          return false;
        }
      ...
      case SUB_GP_LIST_NODE:    //节点信息
      {
        ...
        if(wDataSize%sizeof(tagGameNode)!=0)
        {
          return false;
        }
      ...
      case SUB_GP_LIST_PAGE:    //页面信息
      {
        ...
        if(wDataSize%sizeof(tagGamePage)!=0)
        {
          return false;
        }
      ...
      case SUB_GP_LIST_FINISH:  //列表信息
      {
        //列表完成
        ASSERT(CServerListData::GetInstance()!=NULL);
        if(CServerListData::GetInstance()!=NULL)
        {
          CServerListData::GetInstance()->OnEventListFinish();
        }
      ...
      case SUB_GP_VIDEO_OPTION: //视频配置
      {
        ...
        if(wDataSize!=sizeof(tagAVServerOption))
        {
          return false;
        }
      ...
      case SUB_GR_KINE_ONLINE:  //类型在线
      {
        ...
        if((wDataSize<wHeadSize)||(wDataSize!=(wHeadSize+pKindOnline->wKindCount*sizeof(tagOnLineInfoKind))))
        {
          return false;
        }
      ...
      case SUB_GR_SERVER_ONLINE:  //房间在线
      {
        ...
        if((wDataSize<wHeadSize)||(wDataSize!=(wHeadSize+pServerOnline->wServerCount*sizeof(tagOnLineInfoServer))))
        {
          return false;
        }
