...
public:
  ...
  //静态函数
public:
  static CTableResource * GetInstance()
  {
    return m_pTableResource;
  }
};
...
public:
  ...
  {
    return m_TableAttribute.bPlaying;
  }
  //密码标志
  virtual bool GetLockerFlag()
  {
    return m_TableAttribute.bLocker;
  }
...
public:
  ...
  //获取资源
  virtual CTableResource * GetTableResource()
  {
    return &m_TableResource;
  }

  //视图接口
public:
  //视图窗口
  virtual CWnd * GetViewWnd()
  {
    return this;
  }
  //视图数据
