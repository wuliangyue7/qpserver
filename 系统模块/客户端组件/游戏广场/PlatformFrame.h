...
public:
  ...
  {
    return m_PlazaViewServer.m_hWnd!=NULL;
  }
  //获取房间
  CPlazaViewServer * GetPlazaViewServer()
  {
    return &m_PlazaViewServer;
  }
...
//  CPlazaViewAffiche * GetPlazaViewAffiche() { return &m_PlazaViewAffiche; }
  //控制视图
  CPlazaViewServerCtrl * GetPlazaViewServerCtrl()
  {
    return &m_PlazaViewServerCtrl;
  }
...
public:
  //获取实例
  static CPlatformFrame * GetInstance()
  {
    return m_pPlatformFrame;
  }
