...
void CDlgTaskDetails::UpdateDetails()
{
  ...
  if(pControl)
  {
    pControl->SetText(m_pTaskParameter->szTaskName);
  }
  ...
  if(pControl)
  {
    pControl->SetText(szTaskProgress);
  }
  ...
  if(pControl)
  {
    pControl->SetText(szTaskTimeLimit);
  }
  ...
  if(pControl)
  {
    pControl->SetText(m_pTaskParameter->szTaskDescribe);
  }
