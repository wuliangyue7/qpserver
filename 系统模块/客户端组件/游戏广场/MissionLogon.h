...
protected:
  ...
  CDlgWebRegister *       m_pDlgWebRegister;
...
public:
  ...
  //显示注册
  VOID ShowRegister(bool bQQLogon, BYTE cbShowFalg=SW_NORMAL);
  //发送信息
...
protected:
  ...
  //道具配置
  bool OnSocketSubQueryPropertyResult(VOID * pData, WORD wDataSize);
  //认证配置
