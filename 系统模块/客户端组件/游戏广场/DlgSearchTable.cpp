...
VOID CDlgSearchTable::OnOK()
{
  ...
  if(pCheckOption!=NULL)
  {
    SearchTable.bOneNull=pCheckOption->GetCheck();
  }
  ...
  if(pCheckOption!=NULL)
  {
    SearchTable.bTwoNull=pCheckOption->GetCheck();
  }
  ...
  if(pCheckOption!=NULL)
  {
    SearchTable.bNotFull=pCheckOption->GetCheck();
  }
  ...
  if(pCheckOption!=NULL)
  {
    SearchTable.bAllNull=pCheckOption->GetCheck();
  }
...
VOID CDlgSearchTable::OnBnClickedAutoJoin()
{
  ...
  if(m_wResultTableID==INVALID_TABLE)
  {
    return;
  }
