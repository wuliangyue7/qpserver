...
public:
  ...
  virtual WORD GetSortID()
  {
    return m_AgentGameKind.wSortID;
  }
};
//////////////////////////////////////////////////////////////////////////////////
...
public:
  ...
  {
    return (m_GameServer.wServerType&GAME_GENRE_MATCH)!=0;
  }
};
...
public:
  ...
  //代理游戏数目
  DWORD GetAgentGameKindCount()
  {
    return (DWORD)m_AgentGameKindItemMap.GetCount();
  }
  //静态函数
public:
  //获取对象
