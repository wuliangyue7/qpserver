...
public:
  //房间标识
  virtual WORD GetServerID()
  {
    return m_GameServer.wServerID;
  }
  //房间类型
  ...
  //房间规则
  virtual DWORD GetServerRule()
  {
    return m_dwServerRule;
  }
  //游戏标识
  virtual WORD GetKindID()
  {
    return m_GameKind.wKindID;
  }
  //类型名字
  virtual LPCTSTR GetKindName()
  {
    return m_GameKind.szKindName;
  }
  //房间名字
  virtual LPCTSTR GetServerName()
  {
    return m_GameServer.szServerName;
  }
  //服务状态
  ...
  //游戏配置
  virtual CParameterGame * GetParameterGame()
  {
    return m_pParameterGame;
  }
  //房间配置
  virtual CParameterServer * GetParameterServer()
  {
    return m_pParameterServer;
  }

  //组件函数
public:
  //网络组件
  virtual ITCPSocket * GetTCPSocket()
  {
    return m_TCPSocketModule.GetInterface();
  }
  //桌子视图
  virtual ITableViewFrame * GetTableViewFrame()
  {
    return m_pITableViewFrame;
  }
  //进程组件
  virtual CProcessManager * GetProcessManager()
  {
    return &m_ProcessManager;
  }
  //等级组件
  virtual IGameLevelParser * GetGameLevelParser()
  {
    return m_GameLevelParserModule.GetInterface();
  }
  //用户组件
  virtual IPlazaUserManager * GetPlazaUserManager()
  {
    return m_PlazaUserManagerModule.GetInterface();
  }
