...
public:
  ...
  //获取玩家
  virtual LPCTSTR __cdecl GetSendUserAccounts()
  {
    return m_strSendUser;
  }
  //获取发送消息
  virtual LPCTSTR __cdecl GetMsg()
  {
    return m_strMsg;
  }
  //获取字体颜色
  virtual COLORREF __cdecl GetChatColor()
  {
    return m_crChatColor;
  }
  //是否自己消息
  virtual bool __cdecl IsSelfMsg()
  {
    return (m_bSelfMsg>0);
  }
  //获取时间
  virtual const SYSTEMTIME& GetMsgTime()
  {
    return m_Time;
  }
...
public:
  //获取记录ID
  virtual DWORD __cdecl GetChatID()
  {
    return m_dwChatID;
  }
  //获取消息数
  virtual INT_PTR __cdecl GetMsgItemCount()
  {
    return m_ChatMsgItemActive.GetCount();
  }
  //枚举消息
...
public:
  //获取玩家接口
  virtual IClientUserItem * __cdecl GetMyselftUserItem()
  {
