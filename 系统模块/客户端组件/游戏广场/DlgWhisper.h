...
public:
  ...
  //设置接口
  VOID SetTCPSocket(ITCPSocket * pITCPSocket)
  {
  ...
  //设置接口
  VOID SetMySelfUserItem(IClientUserItem * pIMySelfUserItem)
  {
  ...
  //设置接口
  VOID SetGameLevelParser(IGameLevelParser * pIGameLevelParser)
  {
    m_pIGameLevelParser=pIGameLevelParser;
  }
  //设置接口
  VOID SetPlazaUserManager(IPlazaUserManager* pIPlazaUserManager)
  {
    m_pIPlazaUserManager=pIPlazaUserManager;
  }
  //设置聊天记录管理接口
  VOID SetChatHistoryManager(IChatHistoryManager *pIChatHistoryManager)
  {
    m_pIChatHistroyManager = pIChatHistoryManager;
  }
